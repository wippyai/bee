...
M.WORKSPACES = "bee.hive_host:workspaces"
...
function M.live(live: Live): Directory
    ...
    local function workspaces(_: Directory, node: string, query: Query): Catalog
        ...
        local reply = live.call({node_id = node, service_id = "bee.hive_host"}, {operation_ref = M.WORKSPACES}, input, {timeout = live.timeout})
