...
local function define_tests()
    test.describe("Codex configuration", function()
        test.it("renders only the reviewed fields for a host provider and measures them", function()
            local decoded, err = configuration.decode("host:provider", provider({schema_revision = "bee.codex-provider@1", name = "bee", base_url = "https://gateway.example.net/v1", model = "gpt-5", reasoning_effort = "high"}))
