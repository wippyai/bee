...
type Bootstrap = {quit_mode: "detach" | "supervisor", legacy_desktop: unknown, arguments: {string}, fullscreen: boolean, secondary_application: string?}
...
function M.bootstrap(value: unknown): Bootstrap?
    if value == nil then return {quit_mode = "detach", legacy_desktop = nil, arguments = {}, fullscreen = false, secondary_application = nil} end
