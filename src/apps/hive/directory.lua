...
M.DESKTOPS_UNAVAILABLE = "desktop catalog is admitted to native clients with an owner execution; workspace applications have none (supervisor lane)"
M.ATTACH_UNAVAILABLE = "desktop attachment from the Hive Manager awaits native client admission (supervisor lane)"
