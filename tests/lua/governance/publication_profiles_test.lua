...
local function define_tests()
    test.describe("application publication host configuration", function()
        ...
        test.it("names the rule and the host configuration when an overlay has no profile", function()
            ...
            test.not_nil(string.find(refused.remedy, "bee.governance:publication_profiles", 1, true))
            ...
            test.not_nil(string.find(host_only.remedy, "bee.governance:activation_profiles", 1, true))
