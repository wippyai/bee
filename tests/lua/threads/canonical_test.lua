-- MIT. Record canonical JSON reads an empty table's list-or-map allocation
-- exactly as the runtime json module does, and as sync's encoder does.
local test = require("test")
local json = require("json")
local canonical = require("canonical")
local function define_tests()
    test.describe("Record canonical JSON empty table shape", function()
