...
func (host *Host) usage(launch app.Launch) string {
	...
	return strings.Join([]string{
		...
		"",
		"Hive:",
		"  bee hive invite [--out FILE]     print a one-line, single-use invite to this node's hive;",
		"  bee hive invite --share DIR      write it to FILE, or to DIR/bee-hive-invite.txt in a shared folder",
