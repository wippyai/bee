...
login bytes. Placement structurally adds only Bee's MCP subtree, refuses a name
collision and passes the additive MCP permission as a literal argument; hooks
