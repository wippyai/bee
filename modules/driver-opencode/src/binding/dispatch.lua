-- MIT. Driver method dispatch for opencode: the next turn is a new process
-- on the resumed session; there is no in-process input channel, and stdin
-- stays closed because the brief travels in argv.
