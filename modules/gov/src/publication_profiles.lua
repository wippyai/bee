...
local function refusal(configuration: Configuration, source_workspace: string, reason: string?): Refusal
    local configure = "a host adds a publication profile for it to bee.governance:publication_profiles"
        .. " and an activation profile to bee.governance:activation_profiles"
