...
local function define_tests()
    test.describe("Thread carrier", function()
        ...
        test.it("refuses cancel intents outside the attempt, its members and its typed boundary", function()
            local thread_id = prepared_attempt()
            test.eq(harness.code(carrier:call("carrier_cancel_intent", {thread_id = thread_id, attempt_id = "missing", state = "cancelling"})), "NOT_FOUND")
