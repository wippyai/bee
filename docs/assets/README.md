...
The self-edit demonstration is planned in
[foundation next steps](../FOUNDATION_NEXT.md). Capture it only after the real
in-app edit, validation and activation path exists.
