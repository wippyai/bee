...
local function request(input: Object): types.Request
    ...
    local decoded, err = types.decode_request({protocol_revision = types.REVISION, request_id = "req-" .. uuid.v7(), idempotency_key = "idem",
        caller_node_id = "laptop", caller_incarnation = "inc-1", owner_ref = {node_id = "forge", service_id = "bee.hive.api"},
        operation_ref = "bee.hive.api:workspaces", operation_revision = "1", input = input, input_digest = digest,
