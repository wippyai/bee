...
local function define_tests()
    test.describe("Timeline surface", function()
        ...
        test.it("reads a thread in owner order, waits without claiming, resumes and refuses a non-member", function()
            ...
            local state = model.new("bee.threads.timeline.proof")
            ...
            local restored = model.new("bee.threads.timeline.proof")
            ...
            local refused = model.new("bee.threads.timeline.outsider")
