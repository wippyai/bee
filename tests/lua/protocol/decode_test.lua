...
local function define_tests()
    test.describe("Process boundary decoding", function()
        test.it("reads native exit failure without confusing successful result values", function()
            test.eq(decode.exit_error({error = "Child failed"}), "Child failed")
            test.is_nil(decode.exit_error({value = {error = "Application data"}}))
            test.is_nil(decode.exit_error(nil))
        end)
