...
function M.render(provider: Provider, gateway_section: string?, instructions: string?): string
    ...
    if provider.model then lines[#lines + 1] = "model = " .. toml_string(provider.model) end
    ...
    if guidance then lines[#lines + 1] = "developer_instructions = " .. toml_string(guidance) end
