...
| `wide` | 160x48 | 158x43 | 4 columns x 3 rows | list 48 cells, detail rest |
...
visualization. The most important panel is first in reading order.
...
```
 MONITOR                                                     Live · 1s
 HEAP 12.4 MiB ▲0.8      GOROUTINES 214        GC 38         QUEUE 0
 ▂▃▄▅▆▇█▇▆▅▄▃▂▂▃▄▅▆      ▅▅▅▅▆▆▆▆▅▅▅▅▆▆       ▁▁▂▂▃▃▄▄       ▁▁▁▁▁▁▁▁
