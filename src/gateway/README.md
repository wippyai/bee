...
profiles declare the two thread-read tools; an explicitly admitted
`thread_message` write remains disabled in all default profiles. Claude/Codex
also declare lifecycle hooks. Standalone Claude/Codex fixture children pass authenticated MCP reads and
