...
func TestMissingPublicationRemainsCancelable(t *testing.T) {
	...
	cancel()
	err := waitOwnerPublication(ctx, func(context.Context) (rendezvous.Descriptor, error) { return rendezvous.Descriptor{}, os.ErrNotExist }, rendezvous.Descriptor{}, make(chan struct{}), func(context.Context) error { return nil })
